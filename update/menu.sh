...
Isadmin=$(curl -sS https://raw.githubusercontent.com/KopralProject/ijin/main/original | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/KopralProject/ijin/main/original | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/update.sh "https://raw.githubusercontent.com/KopralProject/original/main/menu/update.sh" && chmod +x /root/update.sh
sleep 2
./update.sh
sleep 5
rm /root/update.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/KopralProject/ijin/main/original)
...
serverV=$( curl -sS https://raw.githubusercontent.com/KopralProject/ijin/main/versi)
if [ "$Isadmin" = "ON" ]; then
